...
flowchart LR
    subgraph docker[" Docker Environment "]
        ...
        mgmt["<b>demasylabs-oracle-server</b><br/>(Management Server)<br/><br/>Components:<br/>+ Node.js<br/><br/>+ Oracle Client<br/><br/>Services:<br/>- sqlcl<br/>- sqlplus<br/>- healthcheck<br/><br/>Ports: <br/>- 3000<br/><br/><b>192.168.1.120</b>"]
